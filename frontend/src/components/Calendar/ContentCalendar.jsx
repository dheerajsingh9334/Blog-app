  ...
  const renderCalendar = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      days.push(
        <div
          key={day}
          className={`p-2 min-h-[80px] border border-gray-200 dark:border-gray-700 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 ${
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">Loading your content calendar...</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
              ...
              <div className="space-y-2">
                <Link 
                  to="/dashboard/create-post"
                  className="w-full text-left px-3 py-2 rounded hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors block"
                >
