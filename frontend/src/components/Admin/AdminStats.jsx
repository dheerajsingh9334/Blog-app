    ...
    <div className="p-6">
        ...
        {statCards.map((stat) => {
          ...
          return (
            <button
              ...
              className={`${stat.bgColor} ${stat.hoverColor} rounded-lg p-6 border border-gray-200 cursor-pointer transition-all duration-200 transform hover:scale-105 hover:shadow-lg`}
            >
        ...
        {detailStats.map((stat) => {
          ...
          return (
            <button
              key={stat.title}
              onClick={() => handleStatClick(stat.tabName)}
              className={`${stat.bgColor} ${stat.hoverColor} rounded-lg p-4 border border-gray-200 cursor-pointer transition-all duration-200 transform hover:scale-105 hover:shadow-md`}
            >
      ...
      {stats.regularUsers !== undefined && (
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          <h3 className="text-lg font-semibold text-gray-900 mb-3">User Distribution</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              onClick={() => handleStatClick('users')}
              className="text-center p-3 rounded-lg hover:bg-white hover:shadow-md transition-all duration-200 cursor-pointer"
            >
      ...
      <div className="mt-8 p-6 bg-white rounded-lg border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center p-4 bg-green-50 hover:bg-green-100 text-green-700 rounded-lg transition-colors duration-200"
          >
          ...
          <button
            ...
            className="flex items-center justify-center p-4 bg-purple-50 hover:bg-purple-100 text-purple-700 rounded-lg transition-colors duration-200"
          >
          ...
          <button
            ...
            className="flex items-center justify-center p-4 bg-orange-50 hover:bg-orange-100 text-orange-700 rounded-lg transition-colors duration-200"
          >
